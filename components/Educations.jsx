        ...
        <section className="pad">
            <div className="container">
                ...
                <div className="flex flex-wrap justify-between gap-[20px]">
                    <div className="w-full lg:w-[49%] order-2 lg:order-1">
                                ...
                                >
                                    ...
                                    >
                                        <AccordionTrigger className="subheading font-[600] justify-start items-center cursor-pointer gap-[10px]">
                                            <span className="color text-[25px]">{edu.icon}</span>{edu.degree}
                                        </AccordionTrigger>
                                        <AccordionContent className="para">
                                            <div className="flex justify-between items-center">
                                                <p className="font-[600] color ">{edu.institute}</p>
                                                <div className="opacity-70">
                                                    {edu.timePeriod.from} - {edu.timePeriod.to}
                                                </div>
                                            </div>
